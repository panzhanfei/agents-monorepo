...
import type { IProjectTasksPageViewModel } from "./useProjectTasksPage";

export type IProjectTasksPageViewProps = { vm: IProjectTasksPageViewModel };

export const ProjectTasksPageView = ({ vm }: IProjectTasksPageViewProps) => {
  const {
    projectId,
    tasksQ,
    runners,
