...
# 不含 ngrok —— 飞书公网打不进来；要隧道请用：bash scripts/dev-with-ngrok.sh feishu-min
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "dev-feishu-min.sh — orchestrator + requirements-agent"
echo ""
echo "飞书公网需隧道请用: bash scripts/dev-with-ngrok.sh feishu-min（本脚本不启动 ngrok）。"
